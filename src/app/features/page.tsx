...
export const metadata = { title: 'Features — Reviewup' }
    ...
    <div className="min-h-screen bg-background text-foreground">
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-10 text-center">
        ...
        <p className="text-lg text-muted-foreground max-w-2xl mx-auto mb-8">
          From instant alerts to AI auto-replies — Reviewup handles your entire review workflow so you can focus on running your business.
        </p>
        <Link href="/signup">
      ...
      <footer className="border-t border-border">
        <div className="max-w-6xl mx-auto px-6 py-8 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-sm text-muted-foreground">© 2026 Reviewup. All rights reserved.</p>
