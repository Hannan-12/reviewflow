...
const T = {
  en: {
    ...
    faq: [
      ...
      { q: 'What languages does GoHighReview support?', a: 'The interface is available in German, English, Spanish, Italian, Arabic, Chinese, and Hindi.' },
      { q: 'Is GoHighReview GDPR compliant?', a: 'Yes. GoHighReview is fully GDPR compliant. All data is stored on European servers and is not shared with third parties.' },
    ],
    cta_h2: 'Ready to take control of your reviews?',
    cta_sub: 'Join businesses using GoHighReview to respond faster and grow their reputation.',
    ...
    footer_copy: '© 2026 GoHighReview. All rights reserved.', footer_gdpr: 'Made in Europe · GDPR compliant',
  ...
  de: {
    ...
    faq: [
      ...
      { q: 'Welche Sprachen unterstützt GoHighReview?', a: 'Die Benutzeroberfläche ist auf Deutsch, Englisch, Spanisch, Italienisch, Arabisch, Chinesisch und Hindi verfügbar.' },
      { q: 'Ist GoHighReview DSGVO-konform?', a: 'Ja. GoHighReview ist vollständig DSGVO-konform. Alle Daten werden auf europäischen Servern gespeichert und nicht an Dritte weitergegeben.' },
    ],
    cta_h2: 'Bereit, deine Bewertungen in den Griff zu bekommen?',
    cta_sub: 'Schließe dich Unternehmen an, die GoHighReview nutzen, um schneller zu antworten und ihre Reputation zu steigern.',
    ...
    footer_copy: '© 2026 GoHighReview. Alle Rechte vorbehalten.', footer_gdpr: 'Made in Europe · DSGVO-konform',
  ...
  es: {
    ...
    faq: [
      ...
      { q: '¿Qué idiomas admite GoHighReview?', a: 'La interfaz está disponible en alemán, inglés, español, italiano, árabe, chino e hindi.' },
      { q: '¿Es GoHighReview compatible con el RGPD?', a: 'Sí. GoHighReview cumple plenamente con el RGPD. Todos los datos se almacenan en servidores europeos.' },
    ],
    cta_h2: '¿Listo para tomar el control de tus reseñas?',
    cta_sub: 'Únete a los negocios que usan GoHighReview para responder más rápido y crecer en reputación.',
    ...
    footer_copy: '© 2026 GoHighReview. Todos los derechos reservados.', footer_gdpr: 'Hecho en Europa · Cumplimiento RGPD',
  ...
  it: {
    ...
    faq: [
      ...
      { q: 'Quali lingue supporta GoHighReview?', a: "L'interfaccia è disponibile in tedesco, inglese, spagnolo, italiano, arabo, cinese e hindi." },
      { q: 'GoHighReview è conforme al GDPR?', a: 'Sì. GoHighReview è pienamente conforme al GDPR. Tutti i dati sono memorizzati su server europei.' },
    ],
    cta_h2: 'Pronto a prendere il controllo delle tue recensioni?',
    cta_sub: "Unisciti alle aziende che usano GoHighReview per rispondere più velocemente e far crescere la reputazione.",
    ...
    footer_copy: '© 2026 GoHighReview. Tutti i diritti riservati.', footer_gdpr: 'Made in Europe · Conforme GDPR',
  ...
  ar: {
    ...
    faq: [
      ...
      { q: 'ما هي اللغات التي يدعمها GoHighReview؟', a: 'الواجهة متاحة بالألمانية والإنجليزية والإسبانية والإيطالية والعربية والصينية والهندية.' },
      { q: 'هل GoHighReview متوافق مع GDPR؟', a: 'نعم. GoHighReview متوافق تماماً مع GDPR. جميع البيانات مخزنة على خوادم أوروبية.' },
    ],
    cta_h2: 'هل أنت مستعد للسيطرة على تقييماتك؟',
    cta_sub: 'انضم إلى الشركات التي تستخدم GoHighReview للرد بشكل أسرع وتنمية سمعتها.',
    ...
    footer_copy: '© 2026 GoHighReview. جميع الحقوق محفوظة.', footer_gdpr: 'صنع في أوروبا · متوافق مع GDPR',
  ...
  zh: {
    ...
    faq: [
      ...
      { q: 'GoHighReview支持哪些语言？', a: '界面提供德语、英语、西班牙语、意大利语、阿拉伯语、中文和印地语版本。' },
      { q: 'GoHighReview符合GDPR吗？', a: '是的。GoHighReview完全符合GDPR。所有数据存储在欧洲服务器上，不与第三方共享。' },
    ],
    cta_h2: '准备好掌控您的评价了吗？',
    cta_sub: '加入使用GoHighReview的企业，更快回复并提升声誉。',
    ...
    footer_copy: '© 2026 GoHighReview。保留所有权利。', footer_gdpr: '欧洲制造 · 符合GDPR',
  ...
  hi: {
    ...
    faq: [
      ...
      { q: 'GoHighReview किन भाषाओं का समर्थन करता है?', a: 'इंटरफ़ेस जर्मन, अंग्रेजी, स्पेनिश, इतालवी, अरबी, चीनी और हिंदी में उपलब्ध है।' },
      { q: 'क्या GoHighReview GDPR अनुपालक है?', a: 'हाँ। GoHighReview पूरी तरह से GDPR अनुपालक है। सभी डेटा यूरोपीय सर्वर पर संग्रहीत है।' },
    ],
    cta_h2: 'अपनी समीक्षाओं पर नियंत्रण लेने के लिए तैयार हैं?',
    cta_sub: 'GoHighReview का उपयोग करने वाले व्यवसायों से जुड़ें और तेज़ी से उत्तर देकर अपनी प्रतिष्ठा बढ़ाएं।',
    ...
    footer_copy: '© 2026 GoHighReview. सर्वाधिकार सुरक्षित।', footer_gdpr: 'यूरोप में निर्मित · GDPR अनुपालक',
...
const testimonials = [
  { quote: 'GoHighReview completely changed how we handle reviews. The AI suggestions are spot-on and our response rate has never been better.', author: 'Sarah M.', role: 'Owner, The Bake House', stars: 5 },
  ...
  { quote: 'Managing multiple locations used to be chaos. GoHighReview brings everything into one place and makes it effortless.', author: 'Priya R.', role: 'Head of Operations, Nosh Group', stars: 5 },
]
