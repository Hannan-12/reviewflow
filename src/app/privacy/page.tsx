      ...
      <div className="max-w-3xl mx-auto px-6 py-16">
        ...
        <div className="prose prose-sm max-w-none space-y-8 text-foreground">
          ...
          <section>
            ...
            <p className="text-muted-foreground leading-relaxed">ReviewFlow connects to your Google Business Profile via OAuth. We access your review data, business location information, and post replies on your behalf only when authorised by you. We do not sell or share your Google data with third parties. You can revoke access at any time from your Google Account settings.</p>
          </section>
